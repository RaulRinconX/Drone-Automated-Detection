...
def process_with_pandas(input_csv: str, output_csv: str, flux_cal: float):
    ...
    # 4) Combinar date + time en Timestamp (sin decimales de segundo)
    ...
    # 5) Convertir dB a mW/Hz, luego a mW (multiplicar por ancho de bin)
    ...
    # 6) Calcular Max Amplitude [dBm] y Frequency [MHz]
    ...
    # 9) Formatear sin notación científica y con decimales fijos
    ...
    # 10) Exportar solo las columnas deseadas
    out = df[[
        'Timestamp',
